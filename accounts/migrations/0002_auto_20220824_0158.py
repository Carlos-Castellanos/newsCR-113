# Generated by Django 4.1 on 2022-08-24 01:58
...
def populate_roles(apps, schemaeditor):
    roles = {
        ...
        "journalist" : "aperson thahr writes journalitic content",
...
def populate_dept(apps, schemaeditor):
    depts = {
        "Headlines": "Importan recents events",
        "Sports" : "News related to sporting events",
        "Society": "News related to people in you community",
